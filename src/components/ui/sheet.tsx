...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ...
    {...props}
    // Ensure overlay is above all app layers even if Tailwind class isn't generated
    style={{ zIndex: 10000, background: 'rgba(0,0,0,0.4)', ...(props as any)?.style }}
    ref={ref}
  />
))
...
>(({ side = "right", className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    <DialogPrimitive.Content
      ...
      // Ensure content is above overlay and header regardless of Tailwind z-classes
      style={{
        zIndex: 10001,
        position: 'fixed',
        top: 0,
        ...
        bottom: 0,
        height: '100vh',
        width: 'min(100vw, 448px)', // ~sm:max-w-md
        ...(props as any)?.style,
      }}
      {...props}
    >
